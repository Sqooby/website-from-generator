  ...
  return (
    <div className="w-full max-w-md mx-auto">
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-3 px-4 py-2.5 border border-gray-300 rounded-lg text-sm font-medium hover:bg-gray-50 transition-colors mb-4"
      >
      ...
      <div className="relative my-4">
        ...
        <div className="relative flex justify-center text-xs text-gray-400 uppercase">
          <span className="bg-white px-2">lub</span>
        </div>
      </div>
